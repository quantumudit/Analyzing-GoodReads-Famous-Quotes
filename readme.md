...
This project focuses on scraping famous quotes and their associated details from [goodreads](https://www.goodreads.com/quotes), performing exploratory data analysis to generate insights and visualize them with the help of Power BI.
