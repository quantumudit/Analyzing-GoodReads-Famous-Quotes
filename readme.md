...
<h4 align="center">Scraping & Analyzing famous quotes from <a href="https://www.goodreads.com/quotes" target="_blank">goodreads</a> website with <a href="https://en.wikipedia.org/wiki/Python_(programming_language)" target="_blank">Python</a> and <a href="https://en.wikipedia.org/wiki/Microsoft_Power_BI" target="_blank">Power BI</a></h4>
...
This project focuses on scraping famous quotes and their associated details from [goodreads][website_link], performing exploratory data analysis to generate insights and visualize them with the help of Power BI.

The repository directory structure is as follows:

├───Analyzing-GoodReads-Famous-Quotes<br>
│ ├───01_WEBSCRAPING<br>
│ ├───02_ETL<br>
│ └───06_RESOURCES<br>
...
- Basics of Python
- Python libraries: Requests, BeautifulSoup4, RegEx, Pandas, DateTime, concurrent_futures
...
[website_link]: https://www.goodreads.com/quotes
